...
const Header = () => {
  ...
  return (
  <header className={`w-full h-[50px] md:h-[80px] bg-white flex items-center justify-between 1-20 sticky top-0 transition-transform duration-300 z-[12] ${show}`}>
    <Wrapper className='h-[60px] flex justify-between items-center'>
      ...
      <div className='flex items-center gap-2 text-black'>
        {/* Icon Start */}
        <div
          className='w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center hover:bg-black/[.05] cursor-pointer relative'
        >
        ...
        {/* Mobile Icon Humberger Start */}
        <div
          className='md:hidden w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center hover:bg-black/[.05] cursor-pointer relative -mr-2'
        >
          {
            mobileMenu ? (
              <VscChromeClose
